...
const CreatePoint = () => {
  ...
  const [ mapInitialPosition, setMapInitialPosition ] = useState<[number, number]>([0, 0]);
  ...
  // Carrega as cidades da API do IBGE baseado no estado selecionado
  useEffect(() => {
  ...
  // Carrega a posição atual do usuário para inicialização do mapa
  useEffect(() => {
  ...
  // Carrega os itens disponíveis para coleta da API do Ecoleta
  useEffect(() => {
  ...
  // Atualiza o estado da UF selecionada
  function handleSelectUf(event: ChangeEvent<HTMLSelectElement>) {
    const uf = event.target.value;
    setSelectedUf(uf);
  }

  // Atualiza o estado da cidade selecionada
  function handleSelectCity(event: ChangeEvent<HTMLSelectElement>) {
    const city = event.target.value;
    setSelectedCity(city);
  }

  // Atualiza o estado da posição clicada no mapa
  ...
  // Envia o formulário para a API do Ecoleta
